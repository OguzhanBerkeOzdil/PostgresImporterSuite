...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ucunb\OneDrive\Masaüstü\Programlama\Python\PostgresImporterSuite'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ucunb\OneDrive\Masaüstü\Programlama\Python\PostgresImporterSuite\Scripts\deactivate.nu'
